    ...
    <div className="max-w-3xl mx-auto py-10 px-5">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Courses included: Data Structures & Algorithms, Full-Stack Web Development, Generative AI, Large System Design, Corporate & Leadership Skills, and Computational Thinking.  <br></br>
            Hands-on projects and mentorship from Google engineers to build real-world problem-solving skills.
          </p>
        </div>
        <div>
